                ...
                <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-10 text-center">
                            <h1 style="color: <?php echo e($site_innerpage_header_title_font_color); ?>;">Device Verification</h1>
                        </div>
                    </div>
...
<?php endif; ?>
                    <form method="POST" action="<?php echo e(route('device_authorization_added')); ?>" class="p-2 p-lg-5 bg-white">
                    <?php echo csrf_field(); ?>    
                        <p>
                        Please, enter the verification code we sent to your email 
                        <?php echo e(Auth::user()->email); ?> for the new device.
                        </p>
                        <input  type="hidden" name="user_email" value="<?php echo e(Auth::user()->email); ?>">
                        <input  type="hidden" name="user_id" value="<?php echo e(Auth::user()->id); ?>">
                        <input  type="hidden" name="device_id" value="<?php echo e(Session::get('device_id')); ?>">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/karimyca/public_html/laravel_project/resources/views/frontend/authorization.blade.php ENDPATH**/ ?>