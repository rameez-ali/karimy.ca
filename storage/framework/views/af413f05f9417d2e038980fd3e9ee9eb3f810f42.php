...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($site_innerpage_header_background_type == \App\Customization::SITE_INNERPAGE_HEADER_BACKGROUND_TYPE_DEFAULT): ?>
        <!--<div class="site-blocks-cover inner-page-cover overlay" style="background-image: url( <?php echo e(asset('frontend/images/placeholder/header-inner.webp')); ?>);" data-stellar-background-ratio="0.5">-->
         ...
         <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url( <?php echo e(asset('frontend/images/placeholder/backgrounds/Login.jpg')); ?>);" data-stellar-background-ratio="0.5">
...
unset($__errorArgs, $__bag); ?>" name="email" <?php if(isset($_COOKIE['email'])): ?> value="<?php echo e($_COOKIE['email']); ?>" <?php endif; ?> value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="password" <?php if(isset($_COOKIE['password'])): ?> value="<?php echo e($_COOKIE['password']); ?>" <?php endif; ?> required autocomplete="current-password">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/karimyca/public_html/laravel_project/resources/views/frontend/auth/login.blade.php ENDPATH**/ ?>