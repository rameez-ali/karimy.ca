...
<head>
    ...
    <title><?php echo e(__('maintenance_mode.seo.title')); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/errors.css')); ?>">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 text-center">
                <span class="display-4 d-block"><?php echo e(__('maintenance_mode.title')); ?></span>
                <div class="mb-4 lead"><?php echo e(__('maintenance_mode.description')); ?></div>
            </div>
        </div>

        <div class="row justify-content-center mt-5">
            <div class="col-md-7 mb-5 text-center">
                <a class="text-secondary" href="#" data-toggle="modal" data-target="#loginModal">
                    <i class="fas fa-user-lock"></i>
                    <?php echo e(__('maintenance_mode.admin-login-modal-title')); ?>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('maintenance_mode.admin-login-modal-title')); ?></h5>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-secondary py-2 px-4 text-white rounded">
...
<?php /**PATH /home/karimyca/public_html/laravel_project/resources/views/maintenance/index.blade.php ENDPATH**/ ?>