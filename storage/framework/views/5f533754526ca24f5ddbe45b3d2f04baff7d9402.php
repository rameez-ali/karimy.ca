...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
                 ...
                 <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" style="background: #fff;border-right: 1px solid #d40909;" href="<?php echo e(route('page.home')); ?>">
            <?php if(empty($site_global_settings->setting_site_logo)): ?>
                ...
                <?php else: ?>
               <img width="100" height="40" src="<?php echo e(Storage::disk('public')->url('setting/' . $site_global_settings->setting_site_logo)); ?>">
                      <?php endif; ?>
    </a>
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item ">
        <a class="nav-link" href="<?php echo e(route('page.home')); ?>">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span><?php echo e(__('backend.sidebar.main-web-url')); ?></span></a>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapse_section" class="collapse" aria-labelledby="collapse_section" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.all.subscribers.web.users')); ?>">All Subscribers List</a>
            </div>
        </div>
    </li>
        ...
        <div id="collapse_page" class="collapse" aria-labelledby="collapse_page" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.settings.page.terms-service.edit')); ?>"><?php echo e(__('backend.sidebar.terms-of-service')); ?></a>
                 <a class="collapse-item" href="<?php echo e(route('admin.settings.page.terms-condition.edit')); ?>"><?php echo e(__('backend.sidebar.terms-and-condition')); ?></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapse_setting_general" class="collapse" aria-labelledby="collapse_setting_general" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" style="display:none;" href="<?php echo e(route('admin.settings.license.edit')); ?>"><?php echo e(__('license_verify.sidebar.license')); ?></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapse_setting_payments" class="collapse" aria-labelledby="collapse_setting_payments" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" style="display:none;" href="<?php echo e(route('admin.settings.payment.razorpay.edit')); ?>"><?php echo e(__('payment.razorpay')); ?></a>
                <a class="collapse-item" href="<?php echo e(route('admin.settings.payment.stripe.edit')); ?>"><?php echo e(__('stripe.stripe')); ?></a>
                <a class="collapse-item" style="display:none;" href="<?php echo e(route('admin.settings.payment.payumoney.edit')); ?>"><?php echo e(__('payumoney.payumoney')); ?></a>
            </div>
        </div>
    </li>
...
<!-- End of Sidebar -->
<?php /**PATH /home/karimyca/public_html/laravel_project/resources/views/backend/admin/partials/sidebar.blade.php ENDPATH**/ ?>