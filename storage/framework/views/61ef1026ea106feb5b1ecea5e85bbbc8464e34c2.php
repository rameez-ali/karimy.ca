...
unset($__errorArgs, $__bag); ?>
                ...
                <input id="terms_condition" value="1" type="checkbox" class="<?php $__errorArgs = ['terms_condition'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-5">
                <input id="authorize_canada" value="1" type="checkbox" class="<?php $__errorArgs = ['authorize_canada'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                     ...
                     <!--Is your Business registered in Canada -->
                        <div class="form-row mb-4">
                        <div class="col-md-5">
                <input id="registered_business_canada" value="1" type="checkbox" class="<?php $__errorArgs = ['registered_business_canada'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                 ...
                 <!--Are you of legal age i.e., 18+? -->
                        <div class="form-row mb-4">
                        <div class="col-md-5">
                <input id="above_18" value="1" type="checkbox" class="<?php $__errorArgs = ['above_18'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('backend.user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/karimyca/public_html/laravel_project/resources/views/backend/user/item/create.blade.php ENDPATH**/ ?>