...
unset($__errorArgs, $__bag); ?>
                                <div class="row mt-3">
                                    <div class="col-8">
                                        ...
                                        <?php else: ?>
                                            <img id="image_preview" src="<?php echo e(url('storage/user/user_image/'. $user_admin->user_image)); ?>" class="img-responsive">
                                        <?php endif; ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/karimyca/public_html/laravel_project/resources/views/backend/admin/user/profile/edit.blade.php ENDPATH**/ ?>