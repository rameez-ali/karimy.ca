                    ...
                    <form method="POST" action="{{ route('user.items.update', $item) }}" id="item-create-form">
                        ...
                        <div class="col-md-4">
                            <!--{{$item->terms_condition}}-->
                                       <input id="terms_condition"  {{ ( (($item->terms_condition === 1 ?  'checked ' : ''))) }} value="1" type="checkbox" class="@error('terms_condition') is-invalid @enderror" name="terms_condition">
                        ...
                        <div class="col-md-5">
                <input id="authorize_canada"  {{ ( (($item->authorize_canada === 1 ?  'checked ' : ''))) }} value="1" type="checkbox" class="@error('authorize_canada') is-invalid @enderror" name="authorize_canada">
                                       
                                       <label for="authorize_canada" class="text-black"> <a href="javascript:void(0);" >{{ __('backend.item.authorize_run_canada') }}</a></label>
                                        
                                        @error('authorize_canada')
                                        <span class="invalid-tooltip">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        @enderror
                     ...
                     <!--Is your Business registered in Canada -->
                        <div class="form-row mb-4">
                        <div class="col-md-5">
                <input id="registered_business_canada" {{ ( (($item->registered_business_canada === 1 ?  'checked ' : ''))) }} value="1" type="checkbox" class="@error('registered_business_canada') is-invalid @enderror" name="registered_business_canada">
                                       
                                       <label for="registered_business_canada" class="text-black"> <a href="javascript:void(0);" >{{ __('backend.item.registered_canada') }}</a></label>
                                        
                                        @error('registered_business_canada')
                                        <span class="invalid-tooltip">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        @enderror
                 ...
                 <!--Are you of legal age i.e., 18+? -->
                        <div class="form-row mb-4">
                        <div class="col-md-5">
                <input id="above_18" {{ ( (($item->above_18 === 1 ?  'checked ' : ''))) }} value="1" type="checkbox" class="@error('above_18') is-invalid @enderror" name="above_18">
                                       
                                       <label for="above_18" class="text-black"> <a href="javascript:void(0);">{{ __('backend.item.18_plus') }}</a></label>
