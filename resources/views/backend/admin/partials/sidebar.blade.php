...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
                 ...
                 <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" style="background: #fff;border-right: 1px solid #d40909;" href="{{ route('page.home') }}">
            @if(empty($site_global_settings->setting_site_logo))
                ...
                @else
               <img width="100" height="40" src="{{ Storage::disk('public')->url('setting/' . $site_global_settings->setting_site_logo) }}">
                      @endif
    </a>
    ...
    <li class="nav-item ">
        <a class="nav-link" href="{{ route('page.home') }}">
            ...
            <span>{{ __('backend.sidebar.main-web-url') }}</span></a>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapse_section" class="collapse" aria-labelledby="collapse_section" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('admin.all.subscribers.web.users') }}">All Subscribers List</a>
            </div>
        </div>
    </li>
        ...
        <div id="collapse_page" class="collapse" aria-labelledby="collapse_page" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('admin.settings.page.terms-service.edit') }}">{{ __('backend.sidebar.terms-of-service') }}</a>
                 <a class="collapse-item" href="{{ route('admin.settings.page.terms-condition.edit') }}">{{ __('backend.sidebar.terms-and-condition') }}</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapse_setting_general" class="collapse" aria-labelledby="collapse_setting_general" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" style="display:none;" href="{{ route('admin.settings.license.edit') }}">{{ __('license_verify.sidebar.license') }}</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapse_setting_payments" class="collapse" aria-labelledby="collapse_setting_payments" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" style="display:none;" href="{{ route('admin.settings.payment.razorpay.edit') }}">{{ __('payment.razorpay') }}</a>
                <a class="collapse-item" href="{{ route('admin.settings.payment.stripe.edit') }}">{{ __('stripe.stripe') }}</a>
                <a class="collapse-item" style="display:none;" href="{{ route('admin.settings.payment.payumoney.edit') }}">{{ __('payumoney.payumoney') }}</a>
            </div>
        </div>
    </li>
