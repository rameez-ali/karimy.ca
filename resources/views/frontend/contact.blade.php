...
@section('content')
    ...
    @if($site_innerpage_header_background_type == \App\Customization::SITE_INNERPAGE_HEADER_BACKGROUND_TYPE_DEFAULT)
        <!--<div class="site-blocks-cover inner-page-cover overlay" style="background-image: url( {{ asset('frontend/images/placeholder/header-inner.webp') }});" data-stellar-background-ratio="0.5">-->
         ...
         <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url( {{ asset('frontend/images/placeholder/backgrounds/Contact.jpg') }});" data-stellar-background-ratio="0.5">
                ...
                <div class="col-md-5">
                    ...
                    <div class="p-4 mb-3 bg-white">
                       ...
                       <p class="mb-4">
                        ...
                        <p style="display:none;" class="mb-0 font-weight-bold">{{ __('frontend.contact.phone') }}</p>
                        <p style="display:none;" class="mb-4"><a href="#">{{ $site_global_settings->setting_site_phone }}</a></p>
