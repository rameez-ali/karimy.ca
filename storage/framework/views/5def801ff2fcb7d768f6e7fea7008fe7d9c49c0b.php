...
unset($__errorArgs, $__bag); ?>" name="state">
                                        <option value="Alberta" <?php echo e($login_user->state == "Alberta"  ? 'selected' : ''); ?>>Alberta</option>
                                        <option value="British Columbia" <?php echo e($login_user->state == "British Columbia"  ? 'selected' : ''); ?>>British Columbia</option>
                                        <option value="Manitoba" <?php echo e($login_user->state == "Manitoba"  ? 'selected' : ''); ?>>Manitoba</option>
                                        <option value="New Brunswick" <?php echo e($login_user->state == "New Brunswick"  ? 'selected' : ''); ?>>New Brunswick</option>
                                        <option value="Newfoundland and Labrador" <?php echo e($login_user->state == "Newfoundland and Labrador"  ? 'selected' : ''); ?>>Newfoundland and Labrador</option>
                                        <option value="Nova Scotia" <?php echo e($login_user->state == "Nova Scotia"  ? 'selected' : ''); ?>>Nova Scotia</option>
                                        <option value="Nunavut" <?php echo e($login_user->state == "Nunavut"  ? 'selected' : ''); ?>>Nunavut</option>
                                        <option value="Ontario" <?php echo e($login_user->state == "Ontario"  ? 'selected' : ''); ?>>Ontario</option>
                                        <option value="Prince Edward Island" <?php echo e($login_user->state == "Prince Edward Island"  ? 'selected' : ''); ?>>Prince Edward Island</option>
                                        <option value="Quebec" <?php echo e($login_user->state == "Quebec"  ? 'selected' : ''); ?>>Quebec</option>
                                        <option value="Saskatchewan" <?php echo e($login_user->state == "Saskatchewan"  ? 'selected' : ''); ?>>Saskatchewan</option>
                                        <option value="Yukon" <?php echo e($login_user->state == "Yukon"  ? 'selected' : ''); ?>>Yukon</option>
                                    </select>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                                <div class="row mt-3">
                                    <div class="col-8">
                                        ...
                                        <?php else: ?>
                                            <img id="image_preview" src="<?php echo e(url('storage/user/user_image/'. $login_user->user_image)); ?>" class="img-responsive">
                                        <?php endif; ?>
...
<?php echo $__env->make('backend.user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/karimyca/public_html/laravel_project/resources/views/backend/user/profile/edit.blade.php ENDPATH**/ ?>