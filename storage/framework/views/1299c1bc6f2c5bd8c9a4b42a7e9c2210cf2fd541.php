<div class="d-block d-md-flex listing vertical listing__item_featured_box">
    ...
    <a href="<?php echo e(route('page.item', $item->item_slug)); ?>" class="img d-block" style="background-image: url(<?php echo e(!empty($item->item_image_medium) ? url('storage/item/' . $item->item_image_medium) : (!empty($item->item_image) ? url('storage/item/' . $item->item_image) : asset('frontend/images/placeholder/full_item_feature_image_medium.webp'))); ?>)">
...
<?php /**PATH /home/karimyca/public_html/laravel_project/resources/views/frontend/partials/paid-item-block.blade.php ENDPATH**/ ?>