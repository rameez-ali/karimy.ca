...
class ItemController extends Controller
{
    ...
    public function approveItem(Item $item, Request $request)
    {
        ...
        if($user_exist)
        {
            ...
            $email_subject = __('email.approved_listing.subject');
             $email_notify_message = [
            __('email.approved_listing.body.body-1'),
            __('email.approved_listing.body.body-3')
        ];
        
        $routeURL = route('page.item',$item->item_slug);
         try
        {
            // to user
        ...
        catch (\Exception $e)
        {
            ...
            //end function to user for adding new listing
    ...
    public function disApproveItem(Item $item, Request $request)
    {
        ...
        {
            $email_user = $user_exist;
            $email_subject = __('email.dissapproved_listing.subject');
             $email_notify_message = [
            __('email.dissapproved_listing.body.body-1'),
            __('email.dissapproved_listing.body.body-3')
        ];
