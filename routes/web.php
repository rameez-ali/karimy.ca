...
Route::middleware(['installed','demo','global_variables','maintenance'])->group(function () {
    ...
    Route::post('/subscribe_user', 'WebsiteSubscriberController@subscribe')->name('page.subscribe.user');
    ...
    Route::group(['prefix'=>'admin','namespace'=>'Admin','middleware'=>['verified','auth','admin'],'as'=>'admin.'], function(){
        ...
        Route::get('/subscribers-list', 'PagesController@getAllSubscribeUsersWeb')->name('all.subscribers.web.users');
        ...
        Route::get('/settings/terms-and-condition', 'SettingController@editTermsAndConditionPageSetting')->name('settings.page.terms-condition.edit');
        Route::post('/settings/terms-and-condition', 'SettingController@updateTermsAndConditionPageSetting')->name('settings.page.terms-condition.update');
