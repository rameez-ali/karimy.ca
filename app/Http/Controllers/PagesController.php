...
class PagesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $categories = Category::withCount(['allItems' => function ($query) use ($active_user_ids, $site_prefer_country_id) {
            ...
            ->orderBy('all_items_count', 'desc')->take(10)->get();
        ...
        public function termsAndCondition(Request $request)
    {
         ...
         * Start SEO
         */
        SEOMeta::setTitle(__('seo.frontend.terms-condition', ['site_name' => empty($settings->setting_site_name) ? config('app.name', 'Laravel') : $settings->setting_site_name]));
        SEOMeta::setDescription('');
        SEOMeta::setCanonical(URL::current());
        SEOMeta::addKeyword($settings->setting_site_seo_home_keywords);
        /**
        ...
        {
            $terms_and_condition = $settings->setting_page_terms_and_condition;
            ...
            return response()->view($theme_view_path . 'terms-agreements',
                compact('terms_and_condition', 'site_innerpage_header_background_type', 'site_innerpage_header_background_color',
                        'site_innerpage_header_background_image', 'site_innerpage_header_background_youtube_video',
                        'site_innerpage_header_title_font_color', 'site_innerpage_header_paragraph_font_color'));
        }
        else
