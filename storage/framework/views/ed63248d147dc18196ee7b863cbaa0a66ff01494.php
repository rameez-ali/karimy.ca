...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-8 text-center">
                            <h1 style="color: <?php echo e($site_innerpage_header_title_font_color); ?>;"><?php echo e(__('frontend.terms-and-condition.title')); ?></h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <?php echo clean($terms_and_condition); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/karimyca/public_html/laravel_project/resources/views/frontend/terms-agreements.blade.php ENDPATH**/ ?>