        ...
        <div class="col-12">
            ...
            <div class="row">
                ...
                <input id="terms_condition" value="1" type="checkbox" class="@error('terms_condition') is-invalid @enderror" name="terms_condition">
                            ...
                            <!-- End Accept Terms Condition -->
                            
                            <!--Have you been authorized to run a business in Canada -->
                        <div class="form-row mb-4">
                        <div class="col-md-5">
                <input id="authorize_canada" value="1" type="checkbox" class="@error('authorize_canada') is-invalid @enderror" name="authorize_canada">
                     ...
                     <!--Is your Business registered in Canada -->
                        <div class="form-row mb-4">
                        <div class="col-md-5">
                <input id="registered_business_canada" value="1" type="checkbox" class="@error('registered_business_canada') is-invalid @enderror" name="registered_business_canada">
                 ...
                 <!--Are you of legal age i.e., 18+? -->
                        <div class="form-row mb-4">
                        <div class="col-md-5">
                <input id="above_18" value="1" type="checkbox" class="@error('above_18') is-invalid @enderror" name="above_18">
