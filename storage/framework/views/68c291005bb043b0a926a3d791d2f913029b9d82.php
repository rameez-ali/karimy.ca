                                                        ...
                                                        <?php endif; ?>
                                                            ...
                                                            <div class="row align-items-center">
                                                                <div class="col-3 col-sm-2 col-md-3 col-lg-2 col-xl-1">
                                                                    ...
                                                                    <?php else: ?>
                                                                        <img id="image_preview" src="<?php echo e(url('storage/user/user_image/'. $item->user->user_image)); ?>" class="img-fluid rounded-circle">
                                                                    <?php endif; ?>
                                                                </div>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/karimyca/public_html/laravel_project/resources/views/backend/admin/item/index.blade.php ENDPATH**/ ?>